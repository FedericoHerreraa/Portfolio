    ...
    return (
        <div className={stylesSobreMi.container}>
            ...
            <div className={stylesSobreMi.info}>
                <div>
                    <p>Hola! Mi nombre es Federico Herrera, tengo 19 años y actualmente estoy en el segundo año de de la lincentiatura en sistemas en la Universidad Argentina de la Empresa. Me apasiona la tencología y la programacion y es por eso que estoy constantemente aprendiendo nuevas teconologías. Tengo conocimientos en la programacion web Front-End y Back-End, tambien en el diseño de algoritmos y en la arquitectura de Software.</p>
                </div>
